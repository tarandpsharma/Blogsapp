...
const About = () => {
    return (
        <>
            ...
            <div className="container mx-auto py-8 bg-gray-100 mt-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white shadow-md p-6 rounded-lg">
                        <h2 className="text-3xl font-bold mb-4 text-gray-800">Welcome to TD Blogs</h2>
                    ...
                    <div className="bg-white shadow-md p-6 rounded-lg">
                        ...
                        <p className="text-lg text-gray-700 mb-4">At TD Blogs, our mission is to:</p>
            ...
            <footer className="bg-white text-black text-center py-2 mt-32">
